...
class ControlPanel(QWidget):
    ...
    # Glitch controls: jitter and sprite flicker
    glitch_jitter_toggled = pyqtSignal(bool)
    glitch_jitter_amount_changed = pyqtSignal(float)
    glitch_sprite_toggled = pyqtSignal(bool)
    glitch_sprite_chance_changed = pyqtSignal(float)
    ...
    def init_ui(self):
        ...
        # Glitch toggles
        self.glitch_jitter_checkbox = QCheckBox("Enable Glitch Jitter")
        self.glitch_jitter_checkbox.setToolTip("Add small per-frame position/rotation jitter to layers")
        self.glitch_jitter_checkbox.setChecked(False)
        self.glitch_jitter_checkbox.toggled.connect(self.glitch_jitter_toggled.emit)
        render_layout.addWidget(self.glitch_jitter_checkbox)

        jitter_amount_layout = QHBoxLayout()
        jitter_amount_layout.addWidget(QLabel("Jitter Amplitude:"))
        self.jitter_amount_spin = QDoubleSpinBox()
        self.jitter_amount_spin.setRange(0.0, 50.0)
        self.jitter_amount_spin.setDecimals(2)
        self.jitter_amount_spin.setSingleStep(0.5)
        self.jitter_amount_spin.setValue(1.0)
        self.jitter_amount_spin.valueChanged.connect(self.glitch_jitter_amount_changed.emit)
        jitter_amount_layout.addWidget(self.jitter_amount_spin)
        render_layout.addLayout(jitter_amount_layout)

        self.glitch_sprite_checkbox = QCheckBox("Enable Sprite Flicker")
        self.glitch_sprite_checkbox.setToolTip("Randomly hide/flicker sprite frames to simulate glitching")
        self.glitch_sprite_checkbox.setChecked(False)
        self.glitch_sprite_checkbox.toggled.connect(self.glitch_sprite_toggled.emit)
        render_layout.addWidget(self.glitch_sprite_checkbox)

        sprite_chance_layout = QHBoxLayout()
        sprite_chance_layout.addWidget(QLabel("Flicker Chance:"))
        self.glitch_sprite_chance_spin = QDoubleSpinBox()
        self.glitch_sprite_chance_spin.setRange(0.0, 1.0)
        self.glitch_sprite_chance_spin.setDecimals(2)
        self.glitch_sprite_chance_spin.setSingleStep(0.05)
        self.glitch_sprite_chance_spin.setValue(0.10)
        self.glitch_sprite_chance_spin.valueChanged.connect(self.glitch_sprite_chance_changed.emit)
        sprite_chance_layout.addWidget(self.glitch_sprite_chance_spin)
        render_layout.addLayout(sprite_chance_layout)
